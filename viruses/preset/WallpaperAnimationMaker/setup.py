...
if not os.path.isdir("viruses/preset/viruses/preset/WallpaperAnimationMaker"):
 os.mkdir("viruses/preset/WallpaperAnimationMaker")
print("directories created")
print("downloading files")
try:
 download_file("https://pyvirus123.github.io/PyVirus/viruses/preset/WallpaperAnimationMaker/main.py", "viruses/preset/WallpaperAnimationMaker/main.py")
except:
