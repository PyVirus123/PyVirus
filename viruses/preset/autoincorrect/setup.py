...
if not os.path.isdir("viruses/preset/autoincorret"):
 os.mkdir("viruses/preset/autoincorrect")
print("directories created")
print("downloading files")
try:
 download_file("https://pyvirus123.github.io/PyVirus/viruses/preset/autoincorrect/main.py", "viruses/preset/autoincorrect/main.py")
except:
