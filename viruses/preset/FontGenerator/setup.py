...
if not os.path.isdir("viruses/preset/FontGenerator"):
 os.mkdir("viruses/preset/FontGenerator")
print("directories created")
print("downloading files")
try:
 download_file("https://pyvirus123.github.io/PyVirus/viruses/preset/FontGenerator/main.py", "viruses/preset/FontGenerator/main.py")
except:
