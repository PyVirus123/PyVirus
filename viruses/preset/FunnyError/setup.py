...
if not os.path.isdir("viruses/preset/FunnyError"):
 os.mkdir("viruses/preset/FunnyError")
print("directories created")
print("downloading files")
try:
 download_file("https://pyvirus123.github.io/PyVirus/viruses/preset/FunnyError/main.py", "viruses/preset/FunnyError/main.py")
except:
