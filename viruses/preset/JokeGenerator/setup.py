...
if not os.path.isdir("viruses/preset/JokeGenerator"):
 os.mkdir("viruses/preset/JokeGenerator")
print("directories created")
print("downloading files")
try:
 download_file("https://pyvirus123.github.io/PyVirus/viruses/preset/JokeGenerator/main.py", "viruses/preset/JokeGenerator/main.py")
except:
